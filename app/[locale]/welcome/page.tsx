 ...
 * both point `next` here now, instead of `/`). Not part of the wizard's own step sequence —
 * it's what comes after step 4 — but the Figma frame still shows the (now-full) progress bar
 * at 4/4, with no Back link (there's nowhere to go back to from here); added in stage 1.4
 * (was missing from the original stage 1.2 build).
 *
